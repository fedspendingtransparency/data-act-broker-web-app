...
export default class CrossFileGenerateModalContainer extends React.Component {
	...
	generateFile() {
		...
		GenerateFilesHelper.generateFile(this.props.type, this.props.submissionID, this.state.file.startDate.format('MM/DD/YYYY'), this.state.file.endDate.format('MM/DD/YYYY'))
		.then((response) => {
