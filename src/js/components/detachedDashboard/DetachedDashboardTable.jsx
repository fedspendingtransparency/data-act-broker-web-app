...
import DetachedHistoryLink from './DetachedHistoryLink.jsx';
...
import DetachedDashboardPaginator from './DetachedDashboardPaginator.jsx';
...
export default class DetachedDashboardTable extends React.Component {
    ...
    render() {
        ...
        if (this.state.totalPages > 1) {
            paginator = <DetachedDashboardPaginator
