...
export default class ResourcesContent extends React.Component {
	...
	render() {
		let content = <div>
					...
					<ul>
						<li>
							FABS File: Financial Assistance data (Award and Awardee Attributes) <a href={this.state.fabs_sample} target='_blank'>Download sample file</a>
						</li>
					</ul>
					...
					<ul>
						...
						<li>
							<a href='/#/resources'>DATA Act Information Model Schema (DAIMS)</a> resources related to FABS including:
							<ul>
								<li>
									<a href='https://community.max.gov/download/attachments/1286474850/DAIMS_Practices_Procedures_v1.1.pdf?api=v2'>DAIMS Practices and Procedures v1.1</a>
								</li>
								<li>
									<a href='http://fedspendingtransparency.github.io/assets/docs/DAIMS_IDD_v1.1.xlsx'>DAIMS IDD v1.1 (D2 tab)</a>
								</li>
								<li>
									<a href='http://fedspendingtransparency.github.io/assets/docs/DAIMS_Domain_Values_v1.1.xlsx'>DAIMS Domain Values v1.1</a>
								</li>
								<li>
									<a href='http://fedspendingtransparency.github.io/assets/docs/DAIMS_Information_Flow_Diagram_v1.1.png'>Information Flow Diagram</a> - An overview of the reporting cadences and sources of data included in the DAIMS.
								</li>
							</ul>
						</li>
					</ul>
			...
			if (this.props.type == 'dabs') {
				content = <div><h5>Reporting Submission Specification (RSS) Resources</h5>
					...
					<ul>
						...
						<li>
							<a href="/#/FABSresources" target="_blank" rel="noopener noreferrer">FABS Resources Page</a>
						</li>
						<li>
			...
			<div className="usa-da-help-content">
				...
				<h2>Resources {this.props.type.toUpperCase()}</h2>
					...
					<span>
						...
						It includes artifacts that provide technical guidance for federal agencies about what data to report to Treasury including the authoritative sources of the data elements and the submission format.
					</span>
