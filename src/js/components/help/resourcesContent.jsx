...
export default class ResourcesContent extends React.Component {
    ...
    render() {
        let github = 'http://fedspendingtransparency.github.io/assets/docs/';
        ...
        let content = <div>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href={community + "1286474850/DAIMS_Practices_Procedures_v1.1.pdf?api=v2"}>DAIMS
                            Practices and Procedures v1.1</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href={github + "DAIMS_Information_Flow_Diagram_v1.1.png"}>Information Flow
                            Diagram</a> - An overview of the reporting cadences and sources of data included
                            in the DAIMS.
                        </li>
                    </ul>
                </li>
            ...
            content = <div><h5>Reporting Submission Specification (RSS) Resources</h5>
                ...
                <ul>
                    <li>
                        ...
                        <a href={aws + "appropValid.csv"} target="_blank" rel="noopener noreferrer">Download sample
                        file</a>
                    </li>
                    <li>
                ...
                <p>These are visual representations of how the different data elements are related. They show the
                groupings of elements and attributes.</p>
                <ul>
                    <li>
                        <a href={github + "DAIMS_RSS_Diagram_File_A_v1.1.pdf"} target="_blank"
                            rel="noopener noreferrer">File A - Appropriation Account Detail</a>
                    </li>
                    <li>
                        <a href={github + "DAIMS_RSS_Diagram_File_B_v1.1.pdf"} target="_blank"
                            rel="noopener noreferrer">File B - Object Class and Program Activity Detail</a>
                    </li>
                    <li>
                        <a href={github + "DAIMS_RSS_Diagram_File_C_v1.1.pdf"} target="_blank"
                            rel="noopener noreferrer">File C - Award Financial Detail</a>
                    </li>
                </ul>
                <h5>Interface Definition Document (IDD) Resources</h5>
                <p>The IDD is listing of the data elements that will be extracted from government-wide procurement
                and financial assistance systems.</p>
                <ul>
                    <li>
                ...
                <ul>
                    <li>
                        <a href={github + "DAIMS_IDD_Diagram_File_D1_v1.1.pdf"} target="_blank"
                            rel="noopener noreferrer">File D1 - Award and Awardee Attributes (Procurement)</a>
                    </li>
                    <li>
                        <a href={github + "DAIMS_IDD_Diagram_File_D2_v1.1.pdf"} target="_blank"
                            rel="noopener noreferrer">File D2 - Award and Awardee Attributes (Financial Assistance)</a>
                    </li>
                    <li>
                        <a href={github + "DAIMS_IDD_Diagram_File_E_v1.1.pdf" }target="_blank"
                            rel="noopener noreferrer">File E - Additional Awardee Attributes</a>
                    </li>
                    <li>
                        <a href={github + "DAIMS_IDD_Diagram_File_F_v1.1.pdf" }target="_blank"
                            rel="noopener noreferrer">File F - Sub-Award Attributes</a>
                    </li>
                </ul>
                ...
                <ul>
                    <li>
                        <a href={github + "DAIMS_Information_Flow_Diagram_v1.1.png"} target="_blank"
                            rel="noopener noreferrer">Information Flow Diagram</a> - An overview of the reporting
                        cadences and sources of data included in the DAIMS.
                    </li>
                    <li>
                    ...
                    <li>
                        <a href={github + "DAIMS_Domain_Values_v1.1.xlsx"}>Domain Values</a> - A listing of the
                        specific set of allowed values for a data element.
                    </li>
                    <li>
                        <a href={github + "DAIMS_Agency_Label_To_Terse_Label_v1.1.xlsx"}>Long Element Name to Short
                        Element Name Crosswalk</a> - A listing of the shortened column names for the data elements
                        in the RSS and IDD.
                    </li>
                </ul>
            </div>;
