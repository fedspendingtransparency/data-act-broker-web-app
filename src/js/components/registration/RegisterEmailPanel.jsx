...
export default class RegisterEmailPanel extends React.Component {
    ...
    render() {
        ...
        let actionComponent = <SubmitEmailButton onClick={this.requestReset.bind(this)} buttonText="Verify this email address" buttonDisabled={this.state.buttonDisabled} />;
        ...
        return (
            <div className="usa-da-login-container">
