...
export default class BlockContent extends React.Component {
    ...
    render() {
        let firstBlock = (<LandingBlock type={this.props.type} icon={<Icons.CloudUpload />}
        ...
        if (this.props.type === 'home') {
            firstBlock = (<LandingBlock type={this.props.type} icon={<h5>DATA Act Broker Submission</h5>}
            ...
            thirdBlock = (<LandingBlock type={this.props.type} icon={<Icons.CloudDownload />}
                ...
                buttonText="Generate D Files" url="#/generateDetachedFiles" />);
        }
