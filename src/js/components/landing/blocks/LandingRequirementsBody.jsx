...
export default class LandingRequirementsBody extends React.Component {
    ...
    render() {
        ...
        let body = (<div>
            ...
            <p className="mt-30"><strong>Files D1, D2, E, and F will be generated for you based on the reporting
            period you provide.</strong></p>
            ...
            body = (<div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        </a> resources related to FABS. See:
                        <ul>
                            <li><a href={"https://community.max.gov/download/attachments/1286474850/DAIMS_Practices_" +
                                "Procedures_v1.1.pdf?version=1&modificationDate=1498857477698&api=v2"} target="_blank"
                                rel="noopener noreferrer">DAIMS Practices &amp; Procedures v1.1</a></li>
                            <li><a href="http://fedspendingtransparency.github.io/assets/docs/DAIMS_IDD_v1.1.xlsx"
                                target="_blank" rel="noopener noreferrer">DAIMS IDD v1.1 (D2 tab)</a></li>
                            <li><a href={"http://fedspendingtransparency.github.io/assets/docs/DAIMS_Domain_Values_" +
                                "v1.1.xlsx"} target="_blank" rel="noopener noreferrer">DAIMS Domain Values v1.1</a></li>
                        </ul>
                    </li>
                </ul>
            </div>);
