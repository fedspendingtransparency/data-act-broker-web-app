            ...
            <div className="usa-da-color-gray-light-half-tone usa-da-login-container usa-grid container">
                <div className="usa-width-one-whole row center-block">
                    ...
                    <div className="row text-center">
                        ...
                        <div className="col-md-4"><button className="usa-da-button-biggest" type="submit" value="Upload XBRL File" disabled>Upload XBRL File</button></div>
                        <div className="col-md-4"><button className="usa-da-button-biggest" type="submit" value="Setup a Data Feed" disabled>Setup a Data Feed</button></div>
                    </div>
                </div>
            </div>
        );
