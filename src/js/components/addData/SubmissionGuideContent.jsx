                                ...
                                <div className="col-md-12 usa-da-steps-line">
                                    ...
                                    <div className="col-md-11 usa-da-reg-wrapper mt-20">
                                        ...
                                        <p>
                                            ...
                                            Broker, you still must upload the generated file yourself in the submission
                                            context  after checking it for accuracy and completeness and making any
                                            appropriate updates. Uploaded files can be provided as comma-separated
                                            values (.csv) or pipe-delimited (.txt) files. Both should be provided in
                                            UTF-8 format.
                                        </p>
                                        <ul>
