                            ...
                            <div className="row">
                                <div className="col-md-12 usa-da-steps-line">
                                    ...
                                    <div className="col-md-11 usa-da-reg-wrapper mt-20">
                                        ...
                                        <p>
                                            You will need to prepare File B &amp; C internally to
                                            complete your submission.
                                            File A can be generated by the Broker or prepared internally.
                                            If you choose to generate File A from the Broker,
                                            you still must upload the generated file yourself
                                            in the submission context  after checking it for
                                            accuracy, completeness and making any appropriate updates.
                                            Uploaded files can be provided as comma-separated
                                            values (.csv) or pipe-delimited (.txt) files.
                                        ...
                                        <p>
                                            Submission information, including sample files and
                                            explanations of how Files A, D1, D2, E and F are generated,
                                            is available on the&nbsp;
                                            <a
                                                target="_blank"
                                                rel="noopener noreferrer"
