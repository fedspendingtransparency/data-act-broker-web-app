...
* Improved the logic used in FABS 37.1 and FABS 43.5.
...
* Added the following columns to D1 per GSDM 1.2.1:
    ...
    * SBA-CertifiedWomen-OwnedSmallBusiness
    * SBA-CertifiedEconomicallyDisadvantagedWomen-OwnedSmallBusiness
    * SmallBusinessJointVenture
* Made USSGL 497210 required for File B.
* Updated descriptions for A30.2 and B28.1 for clarity on exceptions.
...
* Prevented users from publishing DABS submissions while comments are being saved.

#### September 30, 2025
In this release of the Broker, we:

* Per GSDM 1.1.1,
    * Added FABS 34.3 to require PeriodOfPerformanceStartDate and PeriodOfPerformanceCurrentEndDate for Grants and Cooperative Agreements.
    * Added USSGLs 480210, 497210 to Files B and C and updated several rules to use them (B6, C6, B13, C18).
    (Effective in the Broker 12/2/25 for FY26 Pd01/02 reporting).
* Updated Help Page side bar navigation for clarity and added the Submission Window Calendar for FY26.
