...
* Improved the performance of validations and the upcoming SAM Contract loader.
* Added preventative unique constraints to various tables.
* Cleaned up database updates to be atomic and sanitized directory names when processing zips.
* Introduced a maximum amount of flex fields supported (50).

#### September 1, 2026

In this release, here is a list of technical changes that may require infrastructure or database updates, or represents additional functionality.

* Updated the subaward loader to pull in specific subawards and reload any missing subaward records.
* Safeguarded several database checks at the atomic level to prevent potential issues.
* Improved how sessions were being managed for security.
* Fixed a minor bug in the assistance listing loader after SAM had fixed their exports.

#### August 11, 2026

In this release, here is a list of technical changes that may require infrastructure or database updates, or represents additional functionality.

* Added “state” verification for Oauth CAIA login for security.
* Cleaning up logic for rules involving all USSGL values.
* Fixed a minor logic issue with FABS44.3.2.
...
* Marked a few columns in FABS as “Conditional Per Validation Rule” for accuracy.
* Added “unlinked” command line argument to SAM Subaward loader to reload specific records.

#### April 28, 2026

In this release, here is a list of technical changes that may require infrastructure or database updates, or represents additional functionality.

* Restructured frontend components to be kept up-to-date: settings, error pages, landing pages, and the DABS review page.
