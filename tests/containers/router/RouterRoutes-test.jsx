...
//                 { path: '/generateDetachedFYPFiles', type: 'dabs' },
//                 { path: '/generateDetachedFileA', type: undefined },
...
//                 { path: '/datasources', type: 'dabs' },
//                 { path: '/FABSdatasources', type: 'fabs' },
